...
cc.MyLoaderScene = cc.Scene.extend({
    ...
    init : function(){
        ...
        // bg
        var bgLayer = self._bgLayer = new cc.LayerColor(cc.color.BLACK);//cc.color(32, 32, 32, 255)
        ...
        //loading percent
        var label = self._label = new cc.LabelTTF(LOADING_TEXT+"0%", "Arial", fontSize);
    ...
    _initStage: function (img, centerPos) {
        ...
        logo.runAction(new cc.RepeatForever(new cc.rotateBy(10,-360)));
    },
    /**
     * custom onEnter
     */
    ...
    _startLoading: function () {
        ...
        cc.loader.load(res,
            function (result, count, loadedCount) {
                ...
                self._label.setString(LOADING_TEXT + percent + "%");
            }, function () {
                if (self.cb)
